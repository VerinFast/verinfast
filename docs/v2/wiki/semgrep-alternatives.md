...
> question for counsel — see [[Open Questions]] **Q12**.
...
4. **Get counsel to confirm** the current `--config auto` posture and whichever
   ruleset is chosen. Recorded as **Q12**.
...
| 16 | Legal review of the rules licence for the current agent **and** for ATD v3 | `S16`, Q12 |
